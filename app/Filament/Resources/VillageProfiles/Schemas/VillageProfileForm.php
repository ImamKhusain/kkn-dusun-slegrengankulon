                ...
                Grid::make([
                    ...
                    ->schema([
                        ...
                        */
                        ...
                        | FORM KANAN
                        |--------------------------------------------------------------------------
                        | Semua section dibuat absolute langsung pada Section,
                        | bukan pada Group, agar posisi form tidak turun saat menu diganti.
                        */
                        Grid::make(1)
                            ->extraAttributes([
                                'style' => 'position: relative; min-height: 1250px;',
                            ])
                            ->schema([
